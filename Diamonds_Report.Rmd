...
It was thought that this calculation may be more useful for both buyers and sellers of round cut diamonds as there may be an acceptable range for the percent error of diamonds' prices predicted using this model. Also, this calculation 
...
perc_split_df <- data.frame("price_group" = split_df$price_group,
                            percerr_1 <- c(preds_price %>% filter(price < 5000 & abs(percent_err) < 1) %>%
